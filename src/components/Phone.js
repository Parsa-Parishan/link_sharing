  ...
  return (
    <div className="phone">
      ...
      >
        ...
        />
        <defs>
          <pattern cx="153.5" cy="112" r="48" fill="#EEE" id="image" patternUnits="userSpaceOnUse">
            <image x="0" y="0" href={placeHolder}/>
          </pattern>
        </defs>
        <circle cx="153.5" cy="112" r="48" fill="url(#image)" id='top'/>
